# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sat Sep 21 11:31:51 2019
#
...
class AtaqueDialog_Ui(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.combo_box_1 = wx.ComboBox(self.tab_ataque, wx.ID_ANY, choices=[], style=wx.CB_DROPDOWN)
        self.button_1 = wx.Button(self.tab_ataque, wx.ID_ANY, "button_1")
        self.btn_run = wx.Button(self.tab_ataque, wx.ID_ANY, "Ejecutar Reaver")
        ...
        self.Bind(wx.EVT_BUTTON, self.on_button_run_reaver, self.btn_run)
    ...
    def __set_properties(self):
        ...
        self.btn_run.SetFont(wx.Font(16, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Noto Sans"))
    ...
    def __do_layout(self):
        ...
        sizer_5.Add(self.combo_box_1, 0, wx.EXPAND, 0)
        sizer_5.Add(self.button_1, 0, wx.EXPAND, 0)
        sizer_5.Add((20, 20), 2, wx.EXPAND | wx.LEFT, 0)
        sizer_5.Add(self.btn_run, 1, wx.ALL | wx.EXPAND, 3)
    ...
    def on_button_run_reaver(self, event):  # wxGlade: AtaqueDialog_Ui.<event_handler>
        print("Event handler 'on_button_run_reaver' not implemented!")
        event.Skip()
