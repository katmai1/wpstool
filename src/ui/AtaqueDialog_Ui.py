...
class AtaqueDialog_Ui(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.btn_reaver_stop = wx.Button(self.tab_ataque, wx.ID_ANY, "Detener Reaver")
        ...
        self.Bind(wx.EVT_BUTTON, self.on_btn_reaver_stop, self.btn_reaver_stop)
    ...
    def __do_layout(self):
        ...
        sizer_5.Add(self.btn_reaver_stop, 0, wx.EXPAND, 0)
    ...
    def on_btn_reaver_stop(self, event):  # wxGlade: AtaqueDialog_Ui.<event_handler>
        print("Event handler 'on_btn_reaver_stop' not implemented!")
        event.Skip()
